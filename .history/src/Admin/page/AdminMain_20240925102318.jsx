...
function AdminMain() {
  ...
  const [image, setImage] = useState(null) // Используйте `null` для изображения
  ...
  const handleSubmit = (e) => {
    ...
    fileReader.onload = (e) => {
      ...
      const myObj = {
        ...
        cost: cost,
        category: category,
        img: e.target.result // Сохранить данные изображения 
      };
    ...
    <div className='wrapper-adminPage'>
      ...
      <div className='wrapper-content'>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input type="file" 
                 onChange={(e) => setImage(e.target.files[0])} // Изменить `value` на `onChange`
